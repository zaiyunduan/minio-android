...
public class StatObjectResponse extends GenericResponse {
  ...
  private DateTime retentionRetainUntilDate;
  ...
  public StatObjectResponse(Headers headers, String bucket, String region, String object) {
    ...
    this.lastModified = Time.HTTP_HEADER_DATE_FORMAT.parseDateTime(headers.get("Last-Modified"));
  ...
  public DateTime retentionRetainUntilDate() {
